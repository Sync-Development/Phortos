...
function filterFunction() {
    ...
    <div class="pt-page-header"><!--Dit stukje code is de tekst dat wordt gedisplayed op de banner van de Consulting pagina-->
	<div class="container">
    ...
    <section class="pt-main"><!--Dit is de section dat wordt gebruikt voor de eerste content blok-->
		<div class="container">
