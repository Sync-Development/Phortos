...
function filterFunction() {
    ...
    <div class="pt-page-header"><!--Dit stukje code is de tekst dat wordt gedisplayed op de banner van de Euretos pagina-->
	<div class="container">
		<div class="pt-page-header-wrapper">
			<div class="pt-header-content">
				<h1 class="page-title">
					 Analytics as a key value add of the Internet of FAIR Data &amp; Services</h1>

				<div class="page-description">
                    <p class="page-description">The Euretos AI Platform for biomarker, target &amp; indication discovery and validation</p>
				</div>
			</div>
       </div>
	</div>
    ...
    <section class="pt-main"><!--Dit is de sectie waar de content blok voor Euretos gedisplayed word-->
		...
		<div class="container">
			...
			<div class="row pt-block-grid pt-equals"> <!--Dit zorgt ervoor dat ze naast elkaar worden weergegeven-->
					...
					<div class="col-md-12"> <!--Dit is de content blok voor Euretos met de volledige breedte-->
						<div class="pt-box pt-box-consult text-center pt-equal" style="">
                            
							<h2 style="margin-top: 4%;">Euretos</h2>
                            <br><!--Hier zit een link dat je zal doorverwijzen naar de euretos website-->
                            ...
                            <hr><!--Hier zit een link dat je zal doorverwijzen naar de euretos website-->
                            <p style="text-align: left;">More information is available at <a href="http://www.euretos.com/" style="color:#68baa5">www.euretos.com.</a></p>
                        </div>
					</div>
