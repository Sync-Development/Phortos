                ...
                <div class="pt-box pt-box-consult text-center pt-equal" style="">
					  <div class="col-md-8">
                          ...
                          <ul class="Ontology-list" style="color: gray; font-family: 'Tauri', sans-serif; font-size: 17px; text-align: left">
                              ...
                              <li>FAIR Data Stewardship and FAIR Data in Practice</li>
                             
                              <li>Semantic Data Modeling and Ontologies</li>  
                                 
                              <li>Semantic Web and Linked Data</li> 
                              
                              <li>FAIRification: Data</li>  
                              
                              <li>FAIRification: Processes</li>  
                              
                              <li>FAIRification: Metadata</li>  
                              
                              <li>The Fair Data Point (FDP) in practice</li>  
                              
                              <li>The value of FAIR data - Results for End Users</li>  
